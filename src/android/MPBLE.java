...
public class MPBLE extends CordovaPlugin implements SdkMethodInterCallBack {
  ...
  public boolean execute(String action, JSONArray args, CallbackContext callbackContext) throws JSONException {
    try {
      if (this.bleEntity == null && !action.equals(SETTYPE) && !action.equals(DISCONNECT)) {
  ...
  private SdkMethodInterFace createEntity(String type) {
    if ("zjtt".equals(type)) {
      ...
      try {
        String className="com." + type + ".android.blesdk.BleBase";
        if("ra29".equals(type)||"saier01".equals(type)){
          className="com." + type + ".android.blesdk.sdk.BleBase";
        }
